...
public class Invoice_Frame_Form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1050, 633));
        ...
        create_Invoice_btn.setBackground(new java.awt.Color(0, 0, 0));
        create_Invoice_btn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        create_Invoice_btn.setForeground(new java.awt.Color(255, 255, 255));
        ...
        delete_Invoice_btn.setBackground(new java.awt.Color(0, 0, 0));
        delete_Invoice_btn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        create_Line_btn.setBackground(new java.awt.Color(0, 0, 0));
        create_Line_btn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        create_Line_btn.setForeground(new java.awt.Color(255, 255, 255));
        create_Line_btn.setText("Save");
        create_Line_btn.setActionCommand("Create_New_Item");

        delete_Line_btn.setBackground(new java.awt.Color(0, 0, 0));
        delete_Line_btn.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        delete_Line_btn.setForeground(new java.awt.Color(255, 255, 255));
        delete_Line_btn.setText("Cancel");
        delete_Line_btn.setActionCommand("Delete_Item");
        delete_Line_btn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                delete_Line_btnActionPerformed(evt);
            }
        });
    ...
    private void delete_Line_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delete_Line_btnActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_delete_Line_btnActionPerformed
